...
userSchema.virtual("myTasks", {
 ...
 localField: "_id",
 //foreignField is the secondary key that the tasks collection is using to recognize the User Model
 foreignField: "owner"
});
...
userSchema.methods.generateAuthToken = async function () {
 const user = this;
 const token = jwt.sign({ _id: user._id.toString() }, process.env.JWT_SECRET_KEY, {expiresIn: "12 minutes"});
